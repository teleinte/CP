...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#usuarionuevo').attr("href", "usuario-nuevo.html")
    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            ?>
                ...
                <form class="clearfix" id="usuario_form_eliminar">
                <div class="contenedor">
                  ...
                  <div class="titulo-principal"><h1 class="title tareas">Usuarios - Eliminar Usuarios</h1></div>
                    <div class="clearfix">
                      <table>
                            <tr>
                                <td colspan="2"><label>Eliminar El usuario seleccionado?</label></td>
                                <td colspan="2">
                                ...
                                <td colspan="2">
                                  ...
                                  <input type="hidden" id = "tiene_ninios" value="">
                                  <input type="hidden" id = "tiene_empleada" value="">
                                  <input type="hidden" id = "tiene_mascota" value="">
                                  <input type="hidden" id = "tiene_bicicleta" value="">
                                  <input type="hidden" id = "tiene_vehiculo" value="">
                                  <input type="hidden" id = "grupo" value="">
                                  <input type="hidden" id = "descripcion" value="">
                                  <input type="hidden" id = "enombre" value="">
                                  <input type="hidden" id = "etelefono" value="">
                                  <input type="hidden" id = "ecorreo" value="">
                                  </td>
                            </tr>
                            <tr>
                              <td colspan="4">
