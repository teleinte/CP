      ...
      <section id="central">
        <div class="contenedor">
            ...
            <?php if($tkest) { ?>
              ...
              <p> Te has registrado con el correo <strong> <?php echo str_replace("cp-", "", $email); ?></strong>, por favor activa tu cuenta escribiendo tu nueva contraseña.</p>
              <div class="login">
                <form id="activation_form" method="POST">                        
                  ...
                  <div class="login-botones">
                    <p><input type="submit" class="btn gray" value="Activar suscripción"/></p>
                  </div>
                </form>
              <div id="alertas"></div>
            <?php } else { ?>
