                ...
                <form class="clearfix" id="form-elmina-pregunta"> 
                  <script type="text/javascript">
                    $(document).ready(function(){
                        ...
                        traerPreguntasModificables(arr,"encuestas/encuesta/pregunta/filtro",params);        
                    });
                </script>
                <div id="alertas"></div>
                <div class="contenedor">
                  <div id="resultado"></div>
                  <div class="titulo-principal"><h1 class="title tareas">Pregunta - Eliminar Pregunta</h1></div>
                    <div class="clearfix">
                     <table style="width:400px!important; margin: auto;">
                          <tr>
                                <td colspan="2"><label id="nombremostrar">Eliminar la pregunta: </label></td>
                                <td colspan="2"></td>                                                                
                            </tr>
                            <tr>
                              <td colspan="2">
                            ...
                            <tr>
                              <td colspan="4">                                
                                ...
                                <a  id="regresador" class="btn icono regresar" href="index.php">Regresar</a>
                              </td>
                            </tr>
                        </table>
                    </div>
