...
<!--                            <tr>
                              <td>
                                ...
                                <select id="invitados" name ="invitados">
                                  ...
                                  <option value="Copropietarios">Ingreso manual de destinatarios</option>
                                </select>
                              </td>
                              <td colspan="2">
                            ...
                            <tr>
                              <td colspan="2">
                                <label>Creación de preguntas para la encuesta:</label>                              
                              </td>                                                              
                            </tr>
                          </table>

                          <div id="pregunta0" class="clearfix" style="padding: 20px 10px 0; border:1px solid #eee; margin-bottom:10px;">
                            <table>
                              <tr>
                                <td>
                                  <label for="enunciado-pregunta0">Enunciado</label>
                                </td>
                                <td>
                                  <input type=text class="input" id="enunciado-pregunta0" name="enunciado-pregunta0" /></td>
                                <td>
                                  <label for="tipo-pregunta0">Tipo de pregunta</label>
                                </td>
                                <td>
                                  <select id="tipo-pregunta0" name="tipo-pregunta0">
                              ...
                              <tr>
                                <td  width="50%" colspan="2">
                                  <label for="opciones-pregunta0">Si la pregunta es de tipo selección, por favor escriba cada opción en una línea</label>
                                </td>
                                <td class="opciones" colspan="2">
                                  <textarea id="opciones-pregunta0" rows="4"></textarea>
                                </td>
                              </tr>
                              <tr>
                                <td  width="50%" colspan="2">
                            ...
                            <div class="botones-form">
                              ...
                              <input type="submit" class="btn icono guardar" value="Guardar encuesta sin enviar"/>
