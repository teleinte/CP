                ...
                <form class="clearfix" id="encuesta_form_eliminar"> 
                  <script type="text/javascript">
                    $(document).ready(function(){
                        ...
                        traerDatosEliminables(arr,"encuestas/encuesta/copropiedad/filtro",params);                        
                    });
                </script>
                <div id="alertas"></div>
                <div class="contenedor">
                  <div id="resultado"></div>
                  <div class="titulo-principal"><h1 class="title tareas">Encuesta - Eliminar Encuesta</h1></div>
                    <div class="clearfix">
                     <table style="width:400px!important; margin: auto;">
                          <tr>
                                <td colspan="2"><label id="nombremostrar">Eliminar la Encuesta</label></td>
                                <td colspan="2"></td>                                                                
                            </tr>
                            <tr>
                              <td colspan="2">
                            ...
                            <tr>
                              <td colspan="4">                                
                                ...
                                <input type="hidden" id = "odestinatario">
