                      ...
                      <form id="form-edita-pregunta">
                          <table>
                              ...
                              <tr>
                                ...
                                <td class="opciones" colspan="2">
                                    Si <input id="obligatoria0" type="checkbox">
                                </td>
                              </tr>
                            </table>
                              </div>
                            <div class="botones-form">
                              <input type="submit" class="btn icono guardar" value="Guardar Pregunta"/>
                              <input type="hidden" id="id_encuesta" value=""/>                              
                              <a id="regresador" class="btn icono regresar" href="algunacosa">Regresar</a>
                            </div>                            
                      </form>
