                    ...
                    $(document).ready(function(e) {
                        ...
                        {                       
                            ...
                            {
                                $('#contenerdor').append('<div class="app"><div id="square"><div class="absoluto"><a href="../reservas/" id="reserva"><img src="../images/cartelera.png" /><h6>Reservas</h6></a></div></div></div>')                                
                    ...
                    <div class="trescolumnas primera">
                        ...
                        <div class="panel" id="app-panel">
                            <div class="aplicaciones" id="contenerdor"></div>
                        </div>
                        <div style="clear:both;"></div>
                        <a class="trigger btn" id="aplicacionesDos" href="#" title="aplicaciones"><img src="../../images/aplicaciones.png" alt="aplicaciones"/></a>
                    </div>