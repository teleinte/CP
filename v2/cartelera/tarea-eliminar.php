    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            ?>
                ...
                <form class="clearfix" id="tarea_form_eliminar"> 
                  <script type="text/javascript">
                      $(document).ready(function(){
                          ...
                          traerDatosEliminables(arr,"tareas/getlistFilter",params);
                ...
                <div class="contenedor">
                  ...
                  <div class="titulo-principal"><h1 class="title tareas">Tareas - Eliminar Tarea</h1></div>
                    <div class="clearfix">
                     <table style="width:400px!important; margin: auto;">
                          <tr>
                                <td colspan="2"><label id="nombremostrar">Eliminar la tarea</label></td>
                                <td colspan="2"></td>                                                                
                            </tr>
                            <tr>
                              <td colspan="2">
                            ...
                            <tr>
                              <td colspan="4">                                
                                ...
                                <input type="hidden" id = "notas">
                                <input type="hidden" id = "frecuencia">
                                <input type="hidden" id = "frecordatorio">
                                <input type="hidden" id = "recordatorio_mail">
                                <input type="hidden" id = "recordatorio_cp">
                                <input type="hidden" id = "compartir_mail">
                                <input type="submit" id="btn_enviar" value="Eliminar Tarea" class="btn icono guardar">
