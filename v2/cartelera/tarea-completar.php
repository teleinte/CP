    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            ?>
                ...
                <form class="clearfix" id="tarea_form_completar"> 
                ...
                <div class="contenedor">
                  ...
                  <div class="titulo-principal"><h1 class="title tareas">Tareas - Completar Tarea</h1></div>
                    <div class="clearfix">
                      <table>
                            <tr>
                                <td colspan="2"><label>Completar la tarea seleccionada?</label></td>
                                <td colspan="2">
                            ...
                            <tr>
                                <td>
                                  <input type="submit" id="btn_enviar" value="Completar Tarea" class="btn icono guardar">
