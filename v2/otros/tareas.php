...
$(document).ready(function() {
	...
	$("div.toolbar").html('<a href="calendario.html" class="btn">Ver en el calendario</a>');
} );
</script>
...
<body>
    ...
    <div id="contenido-principal">
        <section id="central">
                ...
                <div class="contenedor">
                	<div class="titulo-principal"><h1 class="title tareas">Mis Tareas</h1></div>
                    <table id="example" class="stripe" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="#">Mantenimiento del ascensor</a></td>
                                <td>Germán Velasquez</td>
                                <td>Alta</td>
                                <td>01/12/2014</td>
                                <td>Por Iniciar</td>
                                <td>Germán Velasquez</td>
                            ...
                            <tr>
                            	<td></td>
                                <td><input type="checkbox" /></td>
                                <td><a href="#">Podado del Jardín</a></td>
                                <td>Senen Lara</td>
                                <td>Media</td>
                                <td>01/12/2014</td>
                                <td>En progreso</td>
                            ...
                            <tr>
                            	<td></td>
                                <td><input type="checkbox" /></td>
                                <td><a href="#">Revisar tejado</a></td>
                                <td>Martín Morales</td>
                                <td>Baja</td>
                                <td>24/11/2014</td>
                                <td>Cerrada</td>
                                <td>Germán Velasquez</td>
