	...
	try
	{
		...
		if($tokenValidado)
		{
			...
			if ($validateUsuario)
			{
				...
				{
					case 'frontdesk_item':
						enviarInformacion('frontdesk', $datos->body, $app);
						break;					
					default:					
	...
	// {
		...
		if($tokenValidado)
		{
			...
			if ($validateUsuario)
			{
				...
				{
					case 'frontdesk_item':					
					    consultaColeccion($app, 'frontdesk', array('id_copropiedad' => (float)$datos->body->id_copropiedad,'estado' => 1));
						break;					
					default:					
						enviarRespuesta($app, false, "Lista Inexistente", "Lista Inexistente");
						break;
