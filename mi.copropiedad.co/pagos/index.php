...
<script>
  ...
  {  
    ...
    try 
    {      
      var pages = $("#copropiedad").msDropdown(
        {
          on:
          {
            ...
            {        
              ...
              if(val!="")
              {
                if (val=="Nueva")
                  {
                    window.open('../copropiedad/copropiedad-nuevodos.php','_parent');
                  }
                else
                  {
 ...
 $(document).ready(function()
    {
      ...
      urls="estado/cuenta/cliente";
      traerDatos(arra,urls,'POST',traerDatosP());
    });
</script>
    ...
    <div id="contenido-principal">
      <section id="central">
        ...
        <div class="contenedor">
           <div class="titulo-principal"><h1 class="title tareas">Pagos Pendientes | Copropiedad</h1></div>
          <div class="floatleft"></div>
          <div class="floatright" style="display:inline-block; margin-bottom:5px;">
            <a href="http://mi.copropiedad.co/dashboard/dashboard.php" class="btn" style="margin-right:5px;">Regresar</a>
          </div>
