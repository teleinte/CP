                    ...
                    $(document).ready(function(e) {
                        ...
                        for (i in endata)
                        {
                            ...
                            if (endata[i]==1)//2)
                            {
                                $('#contenerdor').append('<div class="app"><div id="square"><div class="absoluto"><a href="../calendario-copropiedad/" id="calendario"><img src="../images/calendario.png" /><h6>Calendario</h6></a></div></div></div>')                                
                            }
                            /*else if (endata[i]==3)
                            {
                            ...
                            else if (endata[i]==5)//12)
                            {
                                ...
                                $('#new-panel').append('<p><a href="../gestion-documental/">Documentos</p>')                               
                            }
                            /*else if (endata[i]==13)
                            {
