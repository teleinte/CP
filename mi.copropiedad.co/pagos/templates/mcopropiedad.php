                      ...
                      $(document).ready(function(e) {
                        ...
                        const rutaAplicatico = "https://app.copropiedad.co/api/admin/copropiedad/";    
                        $.ajax(
                            {
                                url: rutaAplicatico+"copropiedad/usuarioCopropiedad/rol/",
                                type: 'POST',
                                ...
                                success: function(msg) 
                                {
                                    ...
                                    /*if(datos==null)
                                    {
                                        window.location = 'soliciteactivacion.php';   
                                    }*/
                                    else
                                    {
                                      var cadena = "";
