    ...
    while($i<count($datos))
    {
        ...
        if($sinPalo[1]==="SI")
        {
            ...
            if($sinPalo2[0]===$tipo || $sinPalo2[0]==="")
            {
                if($tipo=="multiple")
                {
                    echo '<div class="alert alert-dismissable alert-error"><strong>Error: </strong>Debe seleccionar una o mas opciones en la pregunta: ' . $sinPalo[4] . ' </div>';
                }
                if ($tipo=="unitario")
                {
                    echo '<div class="alert alert-dismissable alert-error"><strong>Error: </strong>Debe seleccionar una opción en la pregunta: ' . $sinPalo[4] . ' </div>';                    
                }
                if($tipo=="abierta")
                {
                    echo '<div class="alert alert-dismissable alert-error"><strong>Error: </strong>Debe escribir una respuesta en la pregunta: ' . $sinPalo[4] . ' </div>';                    
                }
                $error+=1;
                $i++;
            }
...
//    var_dump($arr);    
    ...
    $ch = curl_init('https://appdes.copropiedad.co/api/encuestas/encuesta/votar/');                                                                      
