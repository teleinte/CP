...
<head>
    <?php include("../template/include/css-2.inc");?>
...
<?php include("../template/include/head.inc") ?>
...
<script src="../template/js/jquery.bsAlerts.js"></script>
</head>
<body id="encuesta">
  <header>
        <div class="contenedor">
			<div class="center"><a href="#" taget="_blank"><img src="../template/images/logo-copropiedad-home.png"/></a></div>
        </div>
  </header>
    ...
    <div id="contenido-principal">
        <section id="central">
        	<div class="contenedor">
                <div class="titulo-principal"><h1 class="title encuestas">
                  <?PHP
                  if($_GET["tp"]=="3")
                  {
                    echo "Encuesta";
                ...
                <input type="button" id="enviarBtn" value="Enviar mis respuestas"/>
