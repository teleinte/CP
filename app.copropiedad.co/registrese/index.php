            ...
            <div class="login">
              <form id="registro_form" method="POST">                        
                ...
                <div class="login-botones">
                  <p><input type="submit" class="btn gray" value="Registrarme"/></p><br>
                  <p><a href="https://app.copropiedad.co" class="btn gray">Volver inicio</a></p><br>
                  <p><a href="index.php" class="btn gray">Borrar todos los campos</a></p>
                </div>
              </form>
              <div id="alertas"></div>
            </div>
