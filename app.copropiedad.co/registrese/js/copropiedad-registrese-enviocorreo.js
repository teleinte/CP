...
function enviocorreoNotificacion(){   
  var rutaAplicativo = "https://app.copropiedad.co/api/mailer/mail/registro/notificacion/";        
  var metodo = "POST";
  var arr = 
  {
    token:sessionStorage.getItem('token'),
...
function enviocorreopwdchg(){   
  var rutaAplicativo = "https://app.copropiedad.co/api/mailer/mail/usuario/infoactualizada/";
  var metodo = "POST";
  var mail = $('#email').val();
  var arr = {
    token:$('#token').val(),
