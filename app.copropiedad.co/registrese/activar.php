  ...
  <div id="contenido-principal">
      <section id="central">
        <div class="contenedor">
            ...
            <?php if($tkest) { ?>
              <h2> Bienvenido a copropiedad <?php echo str_replace("%20", " ", $nombre); ?></h2>
              <p> Se ha registrado con el correo <strong> <?php echo str_replace("cp-", "", $email); ?></strong>, por favor active su cuenta escribiendo su nueva contraseña.</p>
              <div class="login">
              <div id="alertas"></div>
                <form id="activation_form" method="POST">                        
                  ...
                  <div class="login-botones">
                    <p><input type="submit" class="btn big" value="Activar suscripción"/></p>
                  </div>
                </form>
            <?php } else { ?>
              <div class="alert alert-dismissable alert-error" style="height:auto; margin:5px auto;">
                <h2>¡Su link ha expirado!</h2><p>Los links de activación tienen una validez de 24 horas. ¿Desea crear un nuevo link para continuar con el proceso?.</p><p style="margin-top: 15px;"><a class="btn gray" style="color:#FFF!important" href="generar-link.php">Haga click aquí</a></p>
              </div>
            <?php } ?>  
            </div>
        </div>
