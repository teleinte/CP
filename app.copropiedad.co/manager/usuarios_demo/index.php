...
<link rel="stylesheet" href="../../css/jquery-ui.css" />
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        traerDatos(arr,'usuarios_demo/getlist/', 'POST');
        /*if($('#tipo').val()=="0")
        {
...
$(document).ready(function() {
  ...
  $("div.toolbar").html('<a href="#" class="btn" id ="open-crearref" style="margin-right:5px;">Nuevo usuario demo</a>');
...
<body>
  <header>
    ...
    <div class="contenedor">
      <div class="titulo-principal"><h1 class="title tareas">Usuarios demo actuales | Copropiedad</h1></div>
