            ...
            <div class="contenedor mitad">
              ...
              <div id="crearcaso">                 
                <form class="clearfix" id="caso_form">
                  <table>
                      <tr>
                          <td colspan="2"><label teid="sp:html:8"></label><textarea id="caso" name="caso" required></textarea></td>
                      </tr>
                       <tr>
                          <td colspan="2"><label teid="sp:html:9"></label><textarea id="notas" name = "notas"></textarea></td>                            
                      </tr> 
                      <tr>
                          <td>
