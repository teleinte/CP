...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        traerDatos(arr,'referencias/getlist/', 'POST');
        /*if($('#tipo').val()=="0")
        {
...
$(document).ready(function() {
  ...
  $("div.toolbar").html('<a href="#" class="btn" id ="open-crearref" style="margin-right:5px;">Nueva referencia</a>');
...
<body>
  <header>
    ...
    <div class="contenedor">
      <div class="titulo-principal"><h1 class="title tareas">Referencias de Pago | Copropiedad</h1></div>
    ...
    <div id="crearref" class="modal" title="Crear nueva referencia"> 
                    <form class="clearfix" id="referencias_form">
                      <table>
                          ...
                          <tr>
                            <td>
                              <label for="time_ref">Tiempo de servicio (meses):</label>
