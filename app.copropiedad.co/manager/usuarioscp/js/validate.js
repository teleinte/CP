$(document).ready(function() {        
        ...
        $("#unidad_form").validate(
        {
            ...
            messages: {
                ...
                nombre0: "Debe poner nombre de usuario",
                apellido0: "Debe poner un apellido",
                telefono0: "Debe poner un telefono de contacto",
                celular0: "Debe poner un numero celular de contacto",
                email0: "Debe poner un corre electronico valido",
                empresa0: "Debe debe poner la empresa a la que pertenece",
                descripcion0:"Debe debe poner la empresa a la que pertenece",                
            },
                    ...
                    for (j=1;j<20;j++)
                    {
                        ...
                        var arr = 
                        {
                          ...
                          body:
                          {
                            ...
                            telefono:$('#telefono'+j).val().replace(' ',''),
                            celular:$('#celular'+j).val(),
                            email:$('#email'+j).val().replace(' ',''),
