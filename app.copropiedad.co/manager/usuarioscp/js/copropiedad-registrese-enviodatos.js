...
{
        var rutaAplicativo = "http://auth.teleinte.com/auth/";
        var arr = 
        {
...
function envioFormularioPassword()
{
    ...
    {
        var rutaAplicativo = "http://auth.teleinte.com/auth/pwd";
        var arr = 
        {
          token:$('#token').val(),
          body:
...
{
    var rutaAplicativo = "https://aws02.sinfo.co/api/mailer/mail/registro/activacion/";
    var rutaActivacion = "https://aws02.sinfo.co/registrese/activar.php?token=";
...
{
    var rutaAplicativo = "https://aws02.sinfo.co/api/mailer/mail/usuario/cambiopassword/";
    var rutaActivacion = "https://aws02.sinfo.co/registrese/confirmar-password.php?token=";
    var code = btoa(encodeURIComponent($('#nombre').val()) + "^cp-" + $('#email').val());
    console.log(rutaActivacion + encodeURIComponent(sessionStorage.getItem('token')) + "&code=" + encodeURIComponent(code));
    var metodo = "POST";
    var arr = {
