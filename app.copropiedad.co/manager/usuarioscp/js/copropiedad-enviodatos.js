...
function envioFormularioUsuarioEncargado(arr,url,params,metodo, numero){  
    if(numero ===0)
    {
        ...
        var rutaAplicatico = "https://aws02.sinfo.co/api/unidad/";
        $.ajax(
        {
            url: rutaAplicatico+url,
            type: metodo,
...
{
//    alert($('#nombre'+numero).val());
//    alert($('#apellido'+numero).val());
//    alert($('#email'+numero).val());
//    alert(sessionStorage.getItem('id_crmPro'));
    var rutaAplicativo = "https://auth.teleinte.com/auth/";
    var arr = 
    {
...
function traerClienteModificables(arr,url,params){
    ...
    rutaAplicativo = "https://aws02.sinfo.co/api/";    
    $.ajax(
    {
