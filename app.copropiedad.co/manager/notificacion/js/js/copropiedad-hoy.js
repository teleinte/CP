            		...
            		$.each(datos3, function(x , y)
            		{
            			...
            			if(y['tipo'] == 'tarea')
            			{
            				...
            				else
            				{
            					...
            					tareasvencidas.push('<li><div class="floatleft"><a https://app.copropiedad.co/api/tarea/">&nbsp;&nbsp;' + y['nombre'] + '</a></div><div class="floatright"> Venció el ' + fechaitem + '</div></li>');
            				}
            			}
            			...
            			else if(y['tipo'] == 'solicitud')
            			{
            				...
            				if(diffDays == 0)
            					solicitudes.push('<li><div class="floatleft"><a https://app.copropiedad.co/solicitudes/">&nbsp;&nbsp;' + y['nombre'] + '</a></div><div class="floatright">Abierta hoy</div></li>');	
            				else
