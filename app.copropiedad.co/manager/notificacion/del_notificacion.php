...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        traerDatosModificables(arr,"notificaciones/edit",params);
...
<body>
    ...
    <div id="contenido-principal">
      <section id="central">        
         <div class="contenedor">
            <div class="titulo-principal"><h1 class="title tareas">Notificaciones | Copropiedad</h1></div>
              <div style="width:400px; margin:0px auto;">  
                   <table style="width:400px!important; margin: auto;">
                    <tr>
                          <td colspan="2"><label id="nombremostrar">Desea eliminar la notificación de copropiedad</label></td>
                          <td colspan="2"></td>                                                                
                      </tr>
                      <tr>
                        <td colspan="2">
                      ...
                      <tr>
                        <td colspan="4">                                
                          ...
                          <input type="hidden" id = "fecha_despliegue">
                    ...
                    <tr>
                      <td colspan="4">
                        <input type="button" class="btn icono guardar" id="btn_eliminar" value="Guardar cambios">  
