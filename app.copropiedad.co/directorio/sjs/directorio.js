$(document).ready(function(){
  ...
  var datos = traerDatosSync("admin/copropiedad/usuario/residente/directorio", arr, sessionStorage.getItem('cp'));
  ...
  $("div.toolbar").append('<a href="directorio_proveedores.php" class="btn" style="margin-right:5px;">Directorio proveedores</a>');
