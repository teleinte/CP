...
class objetoto
{
	...
	public $currency="COP";
	public $lng="es";
	public $responseUrl="https://appdes.copropiedad.co/perfil/respuesta.php";
	public $confirmationUrl= "https://appdes.copropiedad.co/api/payu/teleinte/";
	...
	public function construirFormOculto()
	{
		...
		echo '<input type="hidden" id="buyerEmail" name="buyerEmail" value="'.$this->buyerEmail.'" >';
