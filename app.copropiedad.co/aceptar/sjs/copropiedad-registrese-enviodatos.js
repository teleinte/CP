...
{
    var rutaAplicativo = "https://appdes.copropiedad.co/api/mailer/mail/registro/activacion/";
...
function envioFormularioCambio()
{
    ...
    var rutaActivacion = "https://appdes.copropiedad.co/registrese/confirmar-password.php?token=";
    var rutaAplicativoAuth = "https://auth.sinfo.co/auth/verify/";
    var existe = false;
