      ...
      .done(function(data){
          ...
          var ldaparr = 
          {
            ...
            body:
            {
              ...
              idioma:"es-CO",
              id_crm:crm,
              password:btoa("19283uj9qwnoa98ndfnsdasdfawer23421DASDasdaf" + crm),
              tipoDocumento:"CC",
...
{   
  ...
  var body = '<h3 style="color:#666 !important;">Bienvenido a Copropiedad.co la manera confiable de administrar Propiedades Horizontales.</h3><h4 style="color:#666 !important;">El usuario de su cuenta es: <strong>' + email + '</strong></h4><h4 style="color:#666 !important;">Para activar su cuenta, es necesario que asigne una contraseña haciendo click en el siguiente botón: </h4><br/><p style="text-align: center; margin-bottom: 0;"><a href="' + link + '" style="background:#f51e7c; color:#fff!important; text-decoration: none; padding:15px 20px; border-radius: 3px;">Asignar contraseña y activar</a></p>';
...
{   
  ...
  var arr = 
  {
    ...
    {  
      ...
      fecha_solicitud:new Date(),
      nombre_remitente:"registro",
      destinos:"gvelasquez@teleinte.com",
