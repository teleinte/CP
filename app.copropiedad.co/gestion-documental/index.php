...
<script type="text/javascript" src="sjs/gestion.js"></script>
</head>
<body>
<header>
        ...
        <section id="central">
            ...
            <div class="contenedor">
              ...
              <div class="titulo-principal">
                <h1 teid="gd:html:2"></h1>
              </div>
              <?php require_once('../template/include/alerts.inc'); ?>
                <table id="documentos" class="stripe" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th></th>
                            <th teid="gd:html:3"></th>
                            <th teid="gd:html:4"></th>
                            <th teid="gd:html:5"></th>
                            <th teid="gd:html:6"></th>
