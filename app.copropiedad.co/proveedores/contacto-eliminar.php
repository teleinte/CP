    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            <div class="contenedor">
              ...
              <div class="titulo-principal"><h1 teid="ctp:html:8"></h1></div>
                    ...
                    <tr>
                      <td colspan="2">
                          <select id="opcion" name="opcion" style="width:95%">
                            <option value="NO" teid="ctp:html:11"></option>
                            <option value="SI" teid="ctp:html:10"></option>                                  
                          </select>
                      </td>                              
                    </tr>
                    <tr>
                      <td colspan="4">                                
                        ...
                        <div class="botones-form">
                          <input type="submit" id="btn_enviar" teid="ctp:val:12, ctp:title:16" class="btn icono guardar ttip positivo">
                        </div>
                      </td>
                    </tr>
                  </table>
