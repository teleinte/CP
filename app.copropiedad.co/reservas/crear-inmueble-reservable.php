    ...
    <section id="central">
      ...
      <div class="contenedor mitad">
        ...
        <div class="titulo-principal">
          <h1 class="title" teid="re:html:14"></h1>
        </div>
              ...
              <table>
                ...
                <tr>
                  <td colspan="3" id = "diasHabilitados">
                    ...
                    <br><span><input type="checkbox" class="chkdias" id="semana" name="semana"><span teid="re:html:63"></span></span>
                  </td>
                </tr>
              </table>
              <div class="botones-form">
                <input type="button" class="btn icono borrar ttip" id="cancelar" teid="re:val:122"/>
                <input type="submit" teid="re:val:20, re:title:55" class="btn icono guardar ttip positivo" value="Crear Inmueble"/>
              </div>
            </form>
