                ...
                <div class="contenedor">
                  ...
                  <script type="text/javascript">
                      $(document).ready(function(){
                        ...
                        var params={};window.location.search.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(str,key,value){params[key] = value;})
                        var arr = {token:sessionStorage.getItem('token'),body:{id_unidad:params['rg']}};
                  ...
                  <div class="contenedor">
                      <div class="titulo-principal"><h1 class="title encuestas">Cambiar Contacto Encargado</h1></div>
                        <div class="clearfix">
                            <form id="usuario_form_cambio">
                                <table style="width:400px!important; margin: auto;">
                          <tr>
                                <td colspan="2"><label id="nombreEncargado"></label></td>
                                <td colspan="2"></td>                                                                
                            </tr>
                            <tr>
                              <td colspan="2">
                            ...
                            <tr>
                              <td colspan="4">                                
                                ...
                                <input type = "hidden" id="id_extra" name="id_extra">
                                <input type = "hidden" id="id_crm_persona_extra" name="id_crm_persona_extra">
                                <input type = "hidden" id="unidad" name="unidad">
                                <input type = "hidden" id="id_usuario" name="id_usuario">                                
                                <input type = "hidden" id="coeficiente" name="coeficiente">
                                <input type = "hidden" id="canon" name="canon">
                                <input type = "hidden" id="proveedor" name="proveedor">
                                
                                <input type="submit" id="btn_enviar" value="Modificar Encargado" class="btn icono guardar">
