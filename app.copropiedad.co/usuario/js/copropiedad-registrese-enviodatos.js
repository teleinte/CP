...
{
    var rutaAplicativo = "http://aws02.sinfo.co/api/mailer/mail/registro/activacion/";
    var rutaActivacion = "http://aws02.sinfo.co/v2/registrese/activar.php?token=";
...
{
    var rutaAplicativo = "http://aws02.sinfo.co/api/mailer/mail/usuario/cambiopassword/";
    var rutaActivacion = "http://aws02.sinfo.co/v2/registrese/confirmar-password.php?token=";
    var code = btoa(encodeURIComponent($('#nombre').val()) + "^cp-" + $('#email').val());
    console.log(rutaActivacion + encodeURIComponent(sessionStorage.getItem('token')) + "&code=" + encodeURIComponent(code));
    var metodo = "POST";
    var arr = {
