                    ...
                    $(document).ready(function(e) {
                        ...
                        {                       
                            if(endata[i]==1)
                            {
                                $('#aplicaciones').append('<div class="app"><div id="square"><div class="absoluto"><a href="../admin/admin.html" id="tarea"><img src="../images/configuracion.png" /><h6>Configuración de la copropiedad</h6></a></div></div></div>')
                            ...
                            {
                                $('#aplicaciones').append('<div class="app"><div id="square"><div class="absoluto"><a href="../tareas/tareas.html" id="tarea"><img src="../images/tareas.png" /><h6>Tareas del administrador</h6></a></div></div></div>')
                            }
                            else if (endata[i]==3)
                            {
