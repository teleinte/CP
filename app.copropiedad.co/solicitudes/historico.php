...
<script type="text/javascript" src="sjs/historico.js"></script>
</head>
<body>
<header>
    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            <div class="contenedor">
              ...
              <div class="titulo-principal"><h1 teid="sl:html:36"></h1></div>
              <?php require_once('../template/include/alerts.inc'); ?>
                <table id="solicitudes" class="stripe" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th></th>
                            <th teid="sl:html:3"></th>
                            <th teid="sl:html:4"></th>
                            <th teid="sl:html:5"></th>
                            <th teid="sl:html:6"></th>
                            <th teid="sl:html:33"></th>
                            <th teid="sl:html:18"></th>
                            <th teid="sl:html:19"></th>
