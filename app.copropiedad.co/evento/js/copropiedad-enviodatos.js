            ...
            success: function(msg) 
            {
                ...
                else
                {
                    $.each(datos, function(x , y) {               
                        ...
                        if(y['cal_copropiedad'] == "true" || y['cal_copropiedad'] == true){comp_cop = true;}
                        if(y['recordatorio_mail'] == "true" || y['recordatorio_mail'] == true){rec_mail = true;}
                        if(y['recordatorio_cp'] == "true" || y['recordatorio_cp'] == true){rec_cp = true;}
                        console.log(comp_cop);
                        console.log(rec_mail);
                        console.log(rec_cp);
                        ...
                        if(idMongoFinal.$id==params['idt'])
                        {
                            ...
                            $('#compartir_maile').val(y['compartir_otros']);
                            $('#compartir_invitados').val(y['compartir_invitados']);
                            $('#frecuenciae').val(y['frecuencia']);
                            $('#ver_copropiedade').prop('checked', comp_cop);
                            $('#datepicker5').val(y['frecordatorio']);
                            $('#recordatorio_maile').prop("checked", rec_mail);
                            $('#recordatorio_cpe').prop("checked", rec_cp);                            
                            $('#notase').val(y['notas']);
                            console.log(y);
                        }                    
                    })
