...
{ 
  ...
  $("#fileuploadera").uploadFile({
    ...
    onSuccess:function(files,data,xhr)
    {
      $("#filepatha").val(data["message"]["ResultadoGeneral"]);
      $(".btn.ajax-file-upload").html(obtenerTerminoLenguage('ca','45'));
      $(".btn.ajax-file-upload").addClass('ajax-file-upload-green');
    }
  });
  ...
  $("#filedeletera").click(function(){$("#filepathaedit").val('');$("#fotoventaa").attr('src','')});
  ...
  $("#fileuploaderedit").uploadFile({
    ...
    onSuccess:function(files,data,xhr)
    {
      ...
      $("#fotoventa").attr('src',data["message"]["ResultadoGeneral"]);
      $(".btn.ajax-file-upload").html( obtenerTerminoLenguage('ca','45'));
      $(".btn.ajax-file-upload").addClass('ajax-file-upload-green');
    }
  });

$("#fileuploaderedita").uploadFile({
  url:traerDireccion()+"api/archivos/archive",
  uploadButtonClass:"btn ajax-file-upload",
  fileName:"archivo",
  autoUpload:false,
  ...
  onSuccess:function(files,data,xhr)
  {
    $("#filepathedita").val(data["message"]["ResultadoGeneral"]);
    $("#fotoventaa").attr('src',data["message"]["ResultadoGeneral"]);
    $(".btn.ajax-file-upload").html( obtenerTerminoLenguage('ca','45'));
    $(".btn.ajax-file-upload").addClass('ajax-file-upload-green');
  }
});
