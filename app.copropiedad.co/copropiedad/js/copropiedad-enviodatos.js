function envioFormulario(arr,url,params,metodo,direccion,nombre){       
        ...
        $.ajax(
        {
            ...
            success: function(msg) 
            {
                ...
                if(mensaje.status)
                {
                    var copropiedad=JSON.parse(JSON.stringify(mensaje.message));                    
                    var arr = 
                    {
                ...
                else
                {
                    $.each(datos, function(x , y) {               
                        ...
                        {                            
                            ...
                            $('#porteria').val(y['tiene_porteria']);
                            $('#ascensor').val(y['tiene_acensor']);
                            $('#zona_ddq').val(y['tiene_zona_ddq']);
                            $('#piscina').val(y['tiene_piscina']);
                            $('#gimnasio').val(y['tiene_gimnasio']);
                            $('#sauna').val(y['tiene_sauna']);
                            $('#turco').val(y['tiene_turco']);
                            $('#jardin').val(y['tiene_jardin']);  
