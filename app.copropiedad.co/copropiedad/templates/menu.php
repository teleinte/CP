                    ...
                    $(document).ready(function(e) {
                        ...
                        {                       
                            if(endata[i]==1)
                            {
                                $('#aplicaciones').append('<div class="app"><div id="square"><div class="absoluto"><a href="../admin/admin.html" id="administracion"><img src="../images/configuracion.png" /><h6>Configuración de la copropiedad</h6></a></div></div></div>')
