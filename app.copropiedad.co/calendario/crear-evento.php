...
<style>
  label{margin-top:10px !important; margin-bottom:0px !important;}
</style>
</head>
<body>
<header>
        ...
        <section id="central">
            ...
            <div class="contenedor mitad">
              ...
              <div class="titulo-principal">
                <h1 class="title calendario" teid="cl:html:74"></h1>
              </div>
              <?php require_once('../template/include/alerts.inc'); ?>
              <form class="clearfix" id="evento_crear_form">
                <table>
                  ...
                  <tr>
                    <td>
                      ...
                      <label for="deadlinee" teid="cl:html:47"></label>
                    ...
                    <td>
                      ...
                      <label for="endtimee" teid="cl:html:48"></label>
                    ...
                    <td>
                     <label for="invitados" teid="cl:html:49"></label>
                      <select id="invitados" name="invitados">
                        ...
                        <!--<option value="proveedor" teid="cl:html:75"></option>-->
                      </select>
                    </td>
                    <td>
                ...
                <div id="botones-form" style="text-align:right">
                  <input type="submit" teid="cl:val:76, cl:title:77" class="btn icono guardar positivo ttip"/>
                </div>
              </form>
