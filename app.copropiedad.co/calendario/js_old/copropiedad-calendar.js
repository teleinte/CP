	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
                ...
                $("#btnr_editar_tarea").click(function(){window.location="../tarea/tarea-editar.php?idt=" + event.id});
                ...
                if(event.tipo == "evento")
                {
                	...
                	$("#btnr_editar_evento").click(function(){window.location="../evento/evento-editar.php?idt=" + event.id});
                	sessionStorage.setItem("referer","../calendario");
			...
			select: function(start, end) {
				...
				$("#calEventDialog").html('<p>Desea crear un nuevo evento iniciando el dia ' +  startdate.split("T")[0] + ' a las ' + startdate.split("T")[1].replace(":00+00:00","") + ' y finalizando el dia ' + enddate.split("T")[0] + ' a las ' + enddate.split("T")[1].replace(":00+00:00",""));
		...
		$('#calEventDialog').dialog({
			...
			buttons:{
				"Crear nuevo evento" : function(){
					window.location="crear.php?#tabs-2";
				},
				"Crear nueva tarea" : function(){
					window.location="crear.php?#tabs-1";
				},
