  ...
  <?php require_once("../template/include/header.inc"); ?>
    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            <div class="titulo-principal"><h1 class="title encuestas" teid="en:html:52"></h1></div>
              ...
              <div class="clearfix">
                <form id="form-edita-pregunta">
                          <table>
                              <tr>
                                <td>
                                  <label for="enunciado_pregunta0" teid="en:html:52"></label>
                                </td>
                                <td>
                                  <input type=text class="input" id="enunciado_pregunta0" name="enunciado_pregunta0" /></td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td class="opciones" colspan="2"><span teid="en:html:23"></span><input id="obligatoria0" type="checkbox">
                                </td>
                              </tr>
                            </table>
                              </div>
                            <div class="botones-form">
                              <input type="submit" class="btn icono guardar ttip positivo" teid="en:val:53, en:title:54"/>
                              <input type="hidden" id="id_encuesta" value=""/>                              
                              <!--<a id="regresador" class="btn icono regresar" href="algunacosa" teid="en:html:55"></a>-->
                            </div>                            
                      </form>
              </div> 
            </div>
