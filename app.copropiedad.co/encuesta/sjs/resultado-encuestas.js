$(document).ready(function() {
    ...
    "language": {
      ...
      "oAria": {
        ...
        $("#alertas").html('<div class="alert alert-dismissable alert-info"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><h4 teid="ale:html:89"></h4><br/> <ul><li  teid="ale:html:90"></li><li  teid="ale:html:91"></li><li  teid="ale:html:92"></li></ul> </div>'); 
        ...
        var arr = {token:sessionStorage.getItem('token'),body:{id_encuesta:params['idt']}};
        var response = traerDatosSync("encuestas/encuesta/resultadosTotales",arr);
        if(response != null)
        ...
        var arr = {token:sessionStorage.getItem('token'),body:{id_encuesta:params['idt']}};
        var response = traerDatosSync("encuestas/encuesta/pregunta/listarIdEncuestas",arr);
