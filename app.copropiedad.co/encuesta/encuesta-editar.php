            ...
            <div class="contenedor mitad">
              <!-- Codigo de la aplicacion -->
                  <div class="titulo-principal">
                    <h1 class="title encuestas" teid="en:html:36"></h1>
                  </div>
                    ...
                    <div class="clearfix">
                      <form id="form-encuesta-editar">
                          ...
                          <div class="botones-form">                            
                            ...
                            <input type="submit" class="btn icono guardar ttip positivo" teid="en:val:37, en:title:38"/>
                          </div>
                        </form>                        
                      </div>
                  </div>
                        <div class="contenedor">
                        <div class="titulo-principal"><h1 class="title encuestas" teid="en:html:39"></h1></div>
                          <table id="tablaPreguntas" class="stripe" cellspacing="0" width="100%">
                              <thead>
                                  <tr>
                                      <th></th>
                                      <th teid="en:html:40"></th>
                                      <th teid="en:html:41"></th>
                                      <th teid="en:html:42"></th>
                                      <th teid="en:html:43"></th>
