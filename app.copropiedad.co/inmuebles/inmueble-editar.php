...
<script type="text/javascript" src="sjs/inmuebles-editar.js"></script>
</head>
<body>
<header>
    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            <div class="contenedor mitad">
              ...
              <div class="titulo-principal"><h1 teid="in:html:22"></h1></div>
              ...
              <form id="form-cliente-editar">
                <table id="form-encuesta-pr">
                  ...
                  <tr>
                    <td>
                      <label for="nombre_inmueble" teid="in:html:7"></label>
                      ...
                      <td>
                        <div class="botones-form">
                          <input type="submit" class="btn icono guardar ttip positivo" teid="in:val:20, in:title:31"/>
                        </div>
                      </td>
                  </tr>
