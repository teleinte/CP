...
<script type="text/javascript" src="sjs/encargado-cambiar.js"></script>
</head>
<body>
<header>
                  ...
                  <table style="width:400px!important; margin: auto;">
                    <tr>
                        <td colspan="2" style="text-align: left;">                          
                          <h4><label id="nombreEncargado"></label></h4>
                        </td>
                        <td colspan="2"></td>                                                                   
                    </tr>
                    <tr>                                
                    ...
                    <tr>
                      <td colspan="4">
                        ...
                        <div class="botones-form">
                          <input type="submit" id="btn_enviar" class="btn icono guardar ttip positivo" teid="ct:val:18, ct:title:19">
                        </div> 
                      </td> 
                    </tr>
                  </table>
