        ...
        <section id="central">
            ...
            <div class="contenedor">
                <div class="titulo-principal">
                  <h1 class="title contabilidad" teid="co:html:130"></h1>
                </div>
                    ...
                    <div class="clearfix">
                      <form>
                          <table id="form-factura">
                              ...
                              <tr>
                                  <td colspan="2"><label teid="co:html:212"></label>
                          ...
                          <table id="agregar-campos">
                              ...
                              <tr>
                                ...
                                <td width="20%" class="titulo-campos" teid="co:html:131"></td>
                          ...
                          <div class="botones-form">
                            <div id="alertasop" style="background-color:white;"></div>
                             <a href="../" class="btn icono borrar ttip" id="btncancelardocumento" style="margin-right:5px;" teid="co:html:119, co:title:223"></a> <input type="button" class="btn icono guardar ttip" teid="co:val:118, co:title:227" id="btnimprimirdocumento"/> <input type="button" class="btn icono guardar ttip positivo" teid="co:val:117, co:title:226" id="btnguardardocumento"/>
                          </div>
                        </form>
                    </div>
                </div>
