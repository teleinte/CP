$(document).ready(function() {
    ...
    $("#consecutivo").html(obtenerConsecutivos("cc",datos));
    ...
    var config = {
      ...
      $('#btRemove').click(function() {
          ...
          if (iCnt <= 10) 
          {
            ...
            $('#btAdd').attr('class', 'btn icono agregar positivo');
          }
      });
        ...
        if(option.val())
        {
          if(cta.val() || cta.val() == undefined)
          {
            if(mov.val() || mov.val() == undefined)
            {
              if(iCnt > 0)
              {
                result = crearDocumento(iCnt, $("#consecutivo").html(), $("#cpnomf").html(), $("#cpema").html(), $("#conceptodoc").val(), "", $("#docext").val(), "CC", $("#idtercero").val(),$("#idnit").val());
                if(result)
                {
