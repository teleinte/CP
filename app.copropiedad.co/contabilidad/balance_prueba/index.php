  ...
  <script type="text/javascript" src="sjs/bpruebas.js?v=1.0"></script>
    ...
    <div id="contenido-principal">
        <section id="central">
            ...
            <div class="titulo-principal"><h1 teid="co:html:188"></h1></div>
            ...
            <div class="centrado">
                  ...
                  <table width="100%">
                    ...
                    <tr>
                      <td style="text-align:right">
                        <label for="mesi" teid="co:html:254"></label>
                      ...
                      <td style="text-align:left">
                        <label for="anoi" teid="co:html:255"></label>
                        <select id="anoi" name="anoi">
              ...
              <br/><input type="button" class="btn ttip positivo" id="generar" teid="co:val:92, co:title:210" />
            </div>
