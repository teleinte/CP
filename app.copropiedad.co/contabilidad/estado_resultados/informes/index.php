    ...
    // echo "este es el final".$formacion;
     ...
     if($Tott<0)
     {
        $cabeceraArchivo->SetFont("Arial", "B", 8);
         ...
         $cabeceraArchivo->Ln();
         $cabeceraArchivo->Line(10,$cabeceraArchivo->GetY(),203,$cabeceraArchivo->GetY());
         $cabeceraArchivo->Cell(70,4,"PERDIDA DEL EJERCICIO");
         ...
         $cabeceraArchivo->SetTextColor(135,14,14);$cabeceraArchivo->Cell(109,4,money_format('%(#1n',$Tott),0,0,'R');
         $cabeceraArchivo->Ln();
         $cabeceraArchivo->Line(10,$cabeceraArchivo->GetY(),203,$cabeceraArchivo->GetY());   
     }
     else
     {
        $cabeceraArchivo->SetFont("Arial", "B", 8);
         ...
         $cabeceraArchivo->Ln();
         $cabeceraArchivo->Line(10,$cabeceraArchivo->GetY(),203,$cabeceraArchivo->GetY());
         $cabeceraArchivo->Cell(70,4,"UTILIDAD DEL EJERCICIO");
         // $cabeceraArchivo->Cell(31,4,money_format('%(#1n',$Sit),0,0,'R');        
         // $cabeceraArchivo->Cell(26,4,money_format('%(#1n',$Dt),0,0,'R');
         // $cabeceraArchivo->Cell(26,4,money_format('%(#1n',$Ct),0,0,'R');
         $cabeceraArchivo->Cell(109,4,money_format('%(#1n',$Tott),0,0,'R');
         $cabeceraArchivo->Ln();
         $cabeceraArchivo->Line(10,$cabeceraArchivo->GetY(),203,$cabeceraArchivo->GetY());
     }
