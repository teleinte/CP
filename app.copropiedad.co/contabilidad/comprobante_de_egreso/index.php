        ...
        <section id="central">
            ...
            <div class="contenedor">
                <div class="titulo-principal">
                  <h1 class="title contabilidad" teid="co:html:125"></h1>
                </div>
                    ...
                    <div class="clearfix">
                      <form>
                          <table id="form-factura">
                              ...
                              <tr>
                                  <td colspan="2"><label teid="co:html:127"></label>
                              ...
                              <tr>
                                  ...
                                  <td colspan="2">
                                    <input type="hidden" id="docext" name="docext" value="na"/>
                                  </td>
                              </tr>
                          </table>
                          ...
                          <div class="botones-form">
                            ...
                            <a href="../" class="btn icono borrar ttip" id="btncancelardocumento" style="margin-right:5px;" teid="co:html:119, co:title:223"></a> <input type="button" class="btn icono guardar ttip" teid="co:val:118, co:title:225" id="btnimprimirdocumento"/> <input type="button" class="btn icono guardar ttip positivo" teid="co:val:117, co:title:224" id="btnguardardocumento"/> <!--<input type="button" class="btn icono borrar" teid="co:val:120" id="btnanulardocumento"/>-->
                          </div>
                        </form>
                    </div>
                </div>
