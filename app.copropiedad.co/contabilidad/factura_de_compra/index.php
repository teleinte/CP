        ...
        <section id="central">
            ...
            <div class="contenedor">
                <div class="titulo-principal">
                  <h1 class="title contabilidad" teid="co:html:107"></h1>
                </div>
                      ...
                      <form>
                          <table id="form-factura">
                              <tr>
                                  ...
                                  <td colspan="2"><label teid="co:html:109"></label><h4 id="comprador"></h4></td>
                                  <td width="25%"><label teid="co:html:110"></label>
                                  <h3 id="consecutivo" style="color:red;"></h3></td>
                              </tr>
                              <tr>
                                  <td colspan="2"><label teid="co:html:111"></label>
