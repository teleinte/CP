...
/*(function($){
  var espanol = {
      errorTitle : 'No se pudo enviar el formulario',
      requiredFields : 'Campo requerido',
      badTime : 'No es una hora válida',
      badEmail : 'No es un correo electrónico válido',
      badTelephone : 'No es un número telefónico válido',
      badSecurityAnswer : 'Su respuesta a la pregunta de seguridad no fue correcta',
      badDate : 'No es una fecha válida',
      lengthBadStart : 'El campo debe tener entre ',
      lengthBadEnd : ' caracteres',
      lengthTooLongStart : 'El campo es más largo que ',
      lengthTooShortStart : 'El campo es más corto que ',
      notConfirmed : 'Los valores no pudieron ser confirmados',
      badDomain : 'Valor de dominio incorrecto',
      badUrl : 'El campo no es una URL correcta',
      badCustomVal : 'Su respuesta es incorrecta',
      badInt : 'No es un número correcto',
      badSecurityNumber : 'Su número de Seguridad Social es incorrecto',
      badUKVatAnswer : 'UK VAT Incorrecto',
      badStrength : 'La contraseña no es lo suficientemente segura',
      badNumberOfSelectedOptionsStart : 'Debe escoger al menos ',
      badNumberOfSelectedOptionsEnd : ' respuestas',
      badAlphaNumeric : 'El campo debe contener solo caracteres alfanuméricos ',
      badAlphaNumericExtra: ' y ',
      wrongFileSize : 'El archivo que está tratando de cargar es demasiado grande',
      wrongFileType : 'El tipo de archivo que está tratando de cargar no es permitido',
      groupCheckedRangeStart : 'Por favor escoja entre ',
      groupCheckedTooFewStart : 'Por favor escoja al menos ',
      groupCheckedTooManyStart : 'Por favor escoja máximo ',
...
$.formUtils.addValidator({
        ...
        validatorFunction : function(val,$el,conf,lang,$form) {
            var radname=$el.attr("name");
			return radioCount=$("input[type=radio][name^='"+radname+"']:checked",$form).length;
        },
        errorMessage : 'Por favor escoja un ítem',
        errorMessageKey: 'noRadio'
    });
...
$.formUtils.addValidator({
        ...
        errorMessage : 'Por favor escoja una opción',
        errorMessageKey: 'noSelect'
    });
